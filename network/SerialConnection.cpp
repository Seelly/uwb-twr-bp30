...
#define DEVICE_STR ("USB-SERIAL CH340")
...
void SerialConnection::readData(void)
{
    if(_processingData)
    {
        ...
        int offset = 0;
        //20181114 patch for office header lenght test, cause our message only have 14bytes
        {
